...
### 📚 Studio
- [ ] Leggi [k-NN tutorial (scikit-learn)](https://scikit-learn.org/stable/modules/neighbors.html)
- [ ] Approfondisci:
...
### 💾 Dataset
- [ ] Scarica dataset di test da [http://corpus-texmex.irisa.fr/](http://corpus-texmex.irisa.fr/)
  - Consiglio: **SIFT** (`sift_base.fvecs`, `sift_query.fvecs`)
- [ ] Trova/scrivi un reader per file `.fvecs` (formato binario)
